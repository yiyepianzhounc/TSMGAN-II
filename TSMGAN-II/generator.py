...
# Define the DualTransformer block class
...
# Define the TwoStageTransformer class
...
# Define the Converlution Attention class
...
# Define the MultiAttention class
...
# Define the class for information interaction
